...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.0, 167.0, 72.0, 23.0 ],
					"text" : "getvdevlist"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 255.0, 122.0, 71.5, 22.0 ],
					"text" : "typeroute~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 167.0, 73.0, 23.0 ],
					"text" : "vdevice $1"
				}
...
, 			{
				"box" : 				{
					"comment" : "Device in (Int) Bang for Device List",
					"id" : "obj-19",
					"index" : 3,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
,
					"patching_rect" : [ 236.0, 237.5, 170.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.0, 167.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 167.0, 37.0, 22.0 ],
					"text" : "close"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 110.0, 140.0, 44.0, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 393.5, 112.0, 54.0, 22.0 ],
					"text" : "sel done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 428.5, 158.0, 116.0, 22.0 ],
					"text" : "route output_texture"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 340.5, 66.0, 72.0, 22.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 340.5, 27.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 427.0, 185.0, 102.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 155.0, 211.0, 202.0, 22.0 ],
